...
const SModal = ({ isOpen, onClose, userId }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-2xl w-96 max-w-md border dark:border-gray-700">
        ...
        {imagePreview && (
          <div className="mt-4 flex justify-center">
            <img
              ...
              alt="Preview"
              className="max-w-full h-auto rounded-xl shadow-xl border-2 border-gray-300 dark:border-gray-600"
            />
          </div>
        )}
